...
class DeactivateButtonAgent(ScAgentClassic):
    def __init__(self):
        super().__init__("action_deact_button")
    ...
    def on_event(self, _1: ScAddr, _2: ScAddr, action_addr: ScAddr) -> ScResult:
        ...
        if button == "вайфай":
            ...
            subprocess.Popen(["powerprofilesctl", "set", "balance"])
