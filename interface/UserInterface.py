...
class GesturesInput(ContentPageWidget):
    ...
    def __init__(self):
        ...
        self.chat_message.setPlaceholderText("Статус жестов появится здесь...")
        self.chat_frame_lay.addWidget(self.chat_message, stretch=1)

        # Нижняя часть: ввод слева, камера справа
        self.bottom_lay = QHBoxLayout()
        self.bottom_lay.setSpacing(10)

        # Левая часть: поле ввода с кнопкой отправки
